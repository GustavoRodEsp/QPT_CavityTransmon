...
using .plotwigner
 ...
 Delta = -2.0
    k = 1.0
    e1 =0.0
plotwigner.plot_combined("output/wigrhoa.dat", Delta, k, e1,"output/wigRhoA.png", "i")
plotwigner.plot_combined("output/wigrhob.dat", Delta, k, e1,"output/wigRhoB.png", "i")

#=
for i in 3.0:0.1:3.3
    # Input file and output file name
    input_file = string("output/gsDelta=", i, ".dat")
    output_combined = string("output/wignerA = ", i, ".png")
